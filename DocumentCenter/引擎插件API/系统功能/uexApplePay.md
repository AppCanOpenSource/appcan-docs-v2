...
## UexAppleCanMakePaymentStatus<ignore>
...
## UexApplePayStartPayResult<ignore>
...
## UexApplePayMerchantCapability<ignore>
...
## UexApplePayContactRequiredFlag<ignore>
...
## UexApplePayShippingType<ignore>
...
## UexApplePayPaymentMethodType<ignore>
...
#### startPay 和 startChinaUnionPay 这2个接口都能进行ApplePay支付,我该用哪个?<ignore>
...
#### 我的应用在启用ApplePay之后被拒了!为什么?<ignore>
