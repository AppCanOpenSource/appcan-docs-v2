...
Title: iOSNative插件开发指南
keywords: appcan开发文档,iOSNative插件开发指南 
description: 本文档主要介绍了如何进行AppCan iOS原生插件开发。更多appcan开发文档，请见http://newdocx.appcan.cn
*/
...
**注2**: 修改target的BuildSettings的方法如下图所示，选中工程主体-选择指定的target-选择BuildSettings-选中all,然后在右上角搜索框中搜索相应的键,双击编辑对应的值
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS1.png) 
...
编辑Build Phases方法如下图所示:选中工程主体-选择target-选择Build Phases - 展开相应的Phase - 点击下方的按钮进行相应的操作
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS2.png)


**注2**:
编辑完成后应该如下图所示:

  ![image](/docximg/openSource-native-capability-dev/iOS3.png) 
...
见下图，红框标注部分都是在插件开发调试中可能会用到的部分。
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS4.png)  
...
* 在AppCan插件开发包中,打开`AppCan引擎头文件`文件夹，找到engineHeader，将此文件夹引入插件工程，如下图所示
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS5.png)  
...
* 好了 让我们运行工程，点击按钮看一下效果吧！
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS6.png) 
...
* 结果如下
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS7.png) 
...
* 结果如下
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS8.png)  
...
* 调用接口后,alert窗口结果如下
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS9.png) 
...
* 控制台显示的结果如下
  ...
  ![image](/docximg/openSource-native-capability-dev/iOS10.png)  
...
* 运行结果如下
   ![image](/docximg/openSource-native-capability-dev/iOS11.gif)  
...
* 结果如下
  ![image](/docximg/openSource-native-capability-dev/iOS12.gif) 
...
* 或者以下列文本为基础,在`<uexplugins>`节点中按照[plugin.xml中注册插件方法的基本规则](/dev-guide/openSource-native-capability-dev/ios-native#-3-2-1-) 完成plugin.xml的编辑
...
* 根据具体情况,将可能存在的以下文件拷贝至此文件夹中,具体请看[5.其他开发说明](/dev-guide/openSource-native-capability-dev/ios-native#-5-)中的说明
  * 第三方库依赖的`.bundle`文件
  * 第三方库的静态`.framework`文件
  * 插件资源包`uexDemoPlugin.bundle`
  * 插件配置文件`uexDemoPlugin.plist`
* 全部拷贝工作完成后，`uexDemoPlugin`文件夹内的内容如下图所示
  ![image](/docximg/openSource-native-capability-dev/iOS14.png)
...
* 选中插件静态库工程，然后点击菜单栏中的File - New - Target.. ,在弹出的对话框中选择OS X - Framework & Library - Bundle
  ![image](/docximg/openSource-native-capability-dev/iOS13.png)
...
* 缺少系统依赖库.
  ...
  * 反之,请去[AppCan引擎github提交issue](https://github.com/AppCanOpenSource/appcan-ios/issues)提issue或者在[AppCan官方论坛](http://bbs.AppCan.cn)发帖说明,我们会第一时间进行反馈.
